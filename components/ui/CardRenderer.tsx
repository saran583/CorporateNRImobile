...
const renderCard = (navigation, title, price, location, features, width=Dimensions.get('window').width * 0.90) => (
  ...
  <Text style={styles1.time}>15 minutes ago</Text>
    ...
    <Image
      ...
      style={styles.image}
    />
    {location !== "search"&&<Text style={{padding:5,backgroundColor:Colors.primary, color:Colors.secondary, borderRadius:5, marginTop:8, textAlign: 'center'}}>Interest</Text>}
    </View>
  </View>
  </TouchableOpacity>
